...
def batch(stage,level):
 ...
 root=H/'runs';root.mkdir(exist_ok=True)
 for variant,q,b,intervention in cases(stage,level):
  ...
  stats={'max_rate':0.,'max_saturated_fraction':0.,'max_context_mean':0.,'max_context_active':0,'finite':True,'step_calls':0};extensions=[]
